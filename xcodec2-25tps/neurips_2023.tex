...
We further benchmark our model against several recent neural audio codecs: SNAC~\cite{siuzdak2024snac}, Encodec~\cite{défossez2022highfidelityneuralaudio}, DAC~\cite{kumar2023highfidelityaudiocompressionimproved}, Mimi~\cite{défossez2024moshispeechtextfoundationmodel}, SpeechTokenizer~\cite{zhang2024speechtokenizerunifiedspeechtokenizer}, UniCodec~\cite{jiang2025unicodecunifiedaudiocodec}, DistilCodec~\cite{wang2025unittsendtoendttsdecoupling}, Neucodec~\cite{julian2025finitescalarquantizationenables} and X-Codec-2.0 baseline.
